			...
			<div id="content" data-url="<?= base_url('transaksikeluar') ?>">
				...
				<div class="clearfix">
					...
					<div class="float-right">
						<a href="<?= base_url('transaksikeluar/export_detail/' . $data_transaksi_keluar->kode_transaksi_keluar) ?>" class="btn btn-danger btn-sm"><i class="fa fa-file-pdf"></i>&nbsp;&nbsp;Export</a>
				...
				<div class="card shadow">
					<div class="card-header"><strong><?= $title ?> - <?= $data_transaksi_keluar->kode_transaksi_keluar ?></strong></div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
