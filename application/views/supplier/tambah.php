								...
								<form action="<?= base_url('supplier/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-4">
											...
											<input type="text" name="kode_supplier" placeholder="Masukkan Kode Supplier" autocomplete="off"  class="form-control" required value="<?= mt_rand(100, 999) ?>" maxlength="8" readonly>
										</div>
									...
									<div class="form-group">
										<label for="alamat_supplier"><strong>Alamat</strong></label>
										<textarea name="alamat_supplier" id="alamat_supplier" style="resize: none;" class="form-control" placeholder="Masukkan Alamat Supplier" required></textarea>
									</div>
									<hr>
									<div class="form-group">
