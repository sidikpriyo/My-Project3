							...
							<div class="card-body">
								<form action="<?= base_url('supplier/proses_ubah/' . $supplier->kode_supplier) ?>" id="form-tambah" method="POST">
									...
									<div class="form-row">
										...
										<div class="form-group col-md-4">
											<label for="no_tlp"><strong>Nimor Telepon</strong></label>
											<input type="number" name="no_tlp" placeholder="Masukkan No Telepon" autocomplete="off"  class="form-control" required value="<?= $supplier->no_tlp ?>">
										</div>
									</div>
									<div class="form-group">
										<label for="alamat_supplier"><strong>Alamat Supplier</strong></label>
										<textarea name="alamat_supplier" id="alamat_supplier" style="resize: none;" class="form-control" placeholder="Masukkan Alamat Supplier" required=""><?= $supplier->alamat_supplier ?></textarea>
									</div>
									<hr>
									<div class="form-group">
