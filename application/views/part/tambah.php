								...
								<form action="<?= base_url('part/proses_tambah') ?>" id="form-tambah" method="POST">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" name="kode_part" placeholder="Masukkan Kode Part" autocomplete="off"  class="form-control">
										</div>
										<div class="form-group col-md-6">
											<label for="nama_part"><strong>Nama Part</strong></label>
											<input type="text" name="nama_part" placeholder="Masukkan Nama Part" autocomplete="off"  class="form-control" required>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
										...
										<!-- <div class="form-group col-md-6">
											...
											<input type="number" name="qty" placeholder="Masukkan Jumlah" autocomplete="off"  class="form-control" required>
										</div> -->
									</div>
										</div>
									<hr>
